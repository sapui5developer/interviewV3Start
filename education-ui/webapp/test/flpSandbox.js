					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAP Course Management",
									"targetURL": "#educationui-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"educationui-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=educationui",
									"url": sap.ui.require.toUrl("educationui")
								}
							}
						}
					}
